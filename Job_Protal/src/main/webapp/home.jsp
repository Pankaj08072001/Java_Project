...
<!-- from loginservelt we get the value of the userobj if the userobje is empty then we it will redirect to login.jsp wala page   -->
...
<!-- if not empty then print the email id  -->
...
<h5 class="text-center text-primary">All Jobs</h5>
 ...
 <!-- Not empty then we get the success msg  -->
